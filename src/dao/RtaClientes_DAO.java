 ...
 * @author Usuario
 */
public class RtaClientes_DAO extends DAO_Abstract{
...
session.beginTransaction();
Criteria criteria = session.createCriteria(RtaCliente.class);
criteria.add(Restrictions.eq("idrtaCliente", codigo));                // seria o msm que select * (tudo) from usuarios
...
return (ArrayList) lista;
 ...
 public List listNome(String nome){
         ...
         session.beginTransaction();
    Criteria crit = session.createCriteria(RtaCliente.class);
