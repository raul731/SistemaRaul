...
if(!jTxtNome.getText().equals("")){
    ...
    if (jTxtNome.getText().equals("") && jTxtcpf.getText().equals("")){
         List list = rtaUsuarios_DAO.listNomeCpf(jTxtNome.getText(), jTxtcpf.getText());
         usuariosController.setList(list);
        }
        }
if (jTxtcpf.getText().equals("")&& jTxtNome.getText().equals("") ){
         List lista = rtaUsuarios_DAO.listCpf(jTxtcpf.getText());
         usuariosController.setList(lista);
         }
